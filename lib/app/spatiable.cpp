#include "../../include/app/spatiable.h"
...
app::tbox app::coarse_bounding_box(const app::tpoly& p)
{
...
app::tbox app::coarse_bounding_box(const spatiable& s) 
{
	return app::coarse_bounding_box(s.get_poly());
}
