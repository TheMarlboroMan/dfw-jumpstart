...
fps_test::fps_test(app::shared_resources& sr)
	:s_resources(sr), frames(0), frames_accum(0), frames_measured(0),
	seconds(0) {

}

void fps_test::loop(dfw::input& input, const dfw::loop_iteration_data& /*lid*/) {
...
void fps_test::draw(ldv::screen& screen, int fps) {
...
bool fps_test::can_leave_state() const {
	return true;
}
